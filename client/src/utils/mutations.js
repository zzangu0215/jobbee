...
mutation addJob($listingName: String!, $description: String!, $createdAt: String!, $companyName:String!) {
    addJob(listingName:$listingName, description:$description, createdAt:$createdAt, companyName:$companyName) {
      listingName
      description
      createdAt
      companyName
